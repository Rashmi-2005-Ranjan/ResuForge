      ...
      <div className="w-full min-h-full bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex justify-between items-center">
              ...
              {user ? (
                  ...
                  <button
                      className="relative group bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2.5 rounded-full font-medium overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/50"
          ...
          <div className="container mx-auto px-4 py-20 lg:py-32 relative z-10">
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
              <div className="flex-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 backdrop-blur-sm text-blue-300 px-4 py-2 rounded-full text-sm font-medium mb-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12">
                  <button
                      className="relative group bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-full font-semibold text-lg flex items-center gap-2 justify-center overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/50"
                      onClick={handleCTA}
                  >
                  ...
                  <button className="border-2 border-slate-700 text-slate-200 px-8 py-4 rounded-full hover:border-slate-600 hover:bg-slate-800/50 transition-all font-semibold text-lg backdrop-blur-sm">
                    View Templates
                  </button>
                </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                  {stats.map((stat, index) => (
                      <div key={index} className="group">
                        <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-4 hover:border-purple-500/50 transition-all duration-300">
              ...
              {features.map((feature, index) => (
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <div className={`mb-6 p-3 bg-gradient-to-br ${feature.gradient} rounded-xl w-fit text-white group-hover:scale-110 transition-transform`}>
                        {feature.icon}
                      </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              <div className="relative group">
                <div className="absolute inset-0 bg-gradient-to-br from-slate-700/20 to-slate-800/20 rounded-3xl blur-xl group-hover:blur-2xl transition-all"></div>
                <div className="relative bg-gradient-to-br from-slate-800/90 to-slate-900/90 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 hover:border-slate-600/50 transition-all duration-300">
                    ...
                    {[
                      ...
                      "Email Support"
                        ...
                        <li key={i} className="flex items-center gap-3">
                          <div className="flex-shrink-0 w-5 h-5 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-full flex items-center justify-center">
                  ...
                  <button
                      className="w-full bg-slate-700 hover:bg-slate-600 text-white py-4 rounded-xl font-semibold transition-all duration-300"
                      onClick={handleCTA}
                  >
                    Get Started Free
                  </button>
              ...
              <div className="relative group">
                ...
                <div className="relative bg-gradient-to-br from-blue-600/10 to-purple-600/10 backdrop-blur-xl border-2 border-purple-500/50 rounded-3xl p-8 hover:border-purple-400/50 transition-all duration-300">
                  ...
                  <div className="text-center mb-8">
                    ...
                    <div className="flex items-baseline justify-center gap-2 mb-2">
                      <span className="text-5xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">₹999</span>
                    </div>
                  ...
                  <ul className="space-y-4 mb-8">
                    {[
                      ...
                      "Custom Branding"
                        ...
                        <li key={i} className="flex items-center gap-3">
                          <div className="flex-shrink-0 w-5 h-5 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center">
                            <Check className="w-3 h-3 text-white" />
                          </div>
                  ...
                  <button
                      className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white py-4 rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-purple-500/50"
                      onClick={handleCTA}
                  >
                    Upgrade to Premium
                  </button>
        ...
        <section className="py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-xl mb-8 text-slate-300">Join thousands of professionals who've landed their dream jobs</p>
            <button
                className="relative group bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-full font-semibold text-lg inline-flex items-center gap-2 overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/50"
                onClick={handleCTA}
            >
            <span className="relative z-10 flex items-center gap-2">
              Start Building Now
              ...
              <div>
                ...
                <div className="flex space-x-3">
                  {[Users, TrendingUp, Award].map((Icon, i) => (
                      <div key={i} className="w-10 h-10 bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-full flex items-center justify-center hover:bg-slate-700/50 hover:border-purple-500/50 cursor-pointer transition-all duration-300 group">
