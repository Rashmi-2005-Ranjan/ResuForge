...
const CreateResumeForm = ({onResumeCreated, onClose}) => {
    ...
    return (
        <div
            className="w-[90vw] md:w-[500px] p-8 bg-gradient-to-br from-slate-900 to-slate-950 rounded-2xl border border-slate-700/50 shadow-2xl">
            {/* Header */}
            ...
            <form onSubmit={handleCreateResume} className="space-y-5">
                ...
                <button
                    ...
                    onClick={onClose}
                    disabled={isLoading}
                    className="w-full cursor-pointer bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-300 font-medium py-3 rounded-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    Cancel
                </button>
            </form>
