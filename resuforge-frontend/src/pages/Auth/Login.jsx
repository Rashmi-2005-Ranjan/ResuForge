    ...
    return (
        <div className="w-[90vw] md:w-[450px] p-8 bg-gradient-to-br from-slate-900 to-slate-950 rounded-2xl border border-slate-700/50 shadow-2xl">
            ...
            <div className="text-center mb-8">
                ...
                <p className="text-sm text-slate-400">Please enter your details to continue</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
                ...
                {needsVerification && (
                    <div className="flex items-center gap-3 p-4 bg-blue-500/10 border border-blue-500/20 rounded-xl">
                        ...
                        <div className="flex-1">
                            ...
                            <button
                                type="button"
                                className="text-sm text-blue-400 hover:text-blue-300 underline font-medium transition-colors cursor-pointer"
                ...
                <div className="text-center pt-4 border-t border-slate-800">
                    <p className="text-sm text-slate-400">
                        ...
                        <button
                            type="button"
                            className="font-semibold text-transparent bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text hover:from-blue-300 hover:to-purple-300 transition-all cursor-pointer"
